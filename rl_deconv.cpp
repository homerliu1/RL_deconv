...
void show3Imgs(Mat org_flt, Mat blurred_flt, Mat estimation)
{
	Size imsz = org_flt.size();
	
	Mat est_view = Mat(imsz.height, imsz.width*3, CV_32FC1);
...
int main( int argc, const char** argv )
{
	...
	Mat org_flt;
	original_image.convertTo(org_flt, CV_32FC1, 1.f/255);
	...
	show3Imgs(org_flt, blurred_flt, estimation);
